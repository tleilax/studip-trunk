...
class AssetHelper {
  ...
  static public $url = '/~mlunzena/tramp/public';
   ...
   */
  static function stylesheet_link_tag() {
   ...
   */
  static function image_tag($source, $opt = array()) {
   ...
   * @ignore
   */
  static function compute_public_path($source, $dir, $ext) {
