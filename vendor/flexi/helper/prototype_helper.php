...
class PrototypeHelper {
   ...
   * @return type <description>
   */
  static function form_remote_tag($options = array(), $html_options = array()) {
   ...
   * @return type <description>
   */
  static function submit_to_remote($name, $value, $options = array()) {
   ...
   * @ignore
   */
  static function options_for_ajax($options) {
   ...
   * @ignore
   */
  static function method_option_to_s($method) {
   ...
   * @ignore
   */
  static function build_observer($klass, $name, $options = array()) {
   ...
   * @ignore
   */
  static function build_callbacks($options) {
    $callbacks = array();
