...
<tr class="<?=TextHelper::cycle('cycle_odd', 'cycle_even')?>">
	...
	<td><?=$person['score']?></td>
	<td><?=$person['title']?> <? if($person['userid']==$user->id): ?><a href="score.php?cmd=kill"><?=_("[löschen]")?></a><? endif; ?></td>
</tr>
<? endforeach;?>
</table>
</div>
...
{
	$action = '<a href="score.php?cmd=kill">'._("Ihren Wert von der Liste löschen").'</a>';
}
else
{
	$action = '<a href="score.php?cmd=write">'._("Diesen Wert auf der Liste veröffentlichen").'</a>';
}
$infobox = array(
	'picture' => 'board2.jpg',
	'content' => array(
