...
<table class="infobox" align="center" width="250" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td class="infobox-img">
      <?= Assets::img('sidebar/group-sidebar.png', array('width' => 260, 'height' => 96)) ?>
    </td>
  </tr>
    ...
    <table align="center" width="99%" border="0" cellpadding="4" cellspacing="0">
      ...
      <tr>
        <td align="center" width="1%" valign="top">
            <?= Icon::create('info', 'info')->asImg(16) ?>
        </td>
      ...
      <tr>
                <td align="center" width="1%" valign="top">
                     <?= ($self_assign_all) ? Icon::create('checkbox-checked', 'info')->asImg(16) : Icon::create('checkbox-unchecked', 'info')->asImg(16) ?>
                </td>
                <td width="99%" align="left">
                    <? if ($self_assign_all) : ?>
      ...
      <tr>
                <td align="center" width="1%" valign="top">
                    <?= ($self_assign_exclusive) ? Icon::create('checkbox-checked', 'info')->asImg(16) : Icon::create('checkbox-unchecked', 'info')->asImg(16) ?>
                </td>
                <td width="99%" align="left">
