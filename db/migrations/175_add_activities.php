...
class AddActivities extends Migration {
    ...
    function up() {
        ...
        $db->exec("CREATE TABLE `activities` (
            ...
            `verb` enum('answered','attempted','attended','completed','created','deleted','edited','experienced','failed','imported','interacted','passed','shared','sent','voided') COLLATE latin1_german1_ci NOT NULL,
