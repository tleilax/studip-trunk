...
class Step00286CourseWizard extends Migration
{
    ...
    function up()
    {
        ...
        if (!CourseWizardStepRegistry::findByClassName('CourseWizardAssignStudyAreas')) {
            $step2 = new CourseWizardStepRegistry();
            $step2->name = _('Studienbereiche');
            $step2->classname = 'AssignStudyAreasWizardStep';
            $step2->number = 2;
            $step2->system = 1;
            $step2->store();
        }
