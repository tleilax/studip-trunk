  ...
  public function up()
   {
    ...
    $db -> exec("CREATE  TABLE IF NOT EXISTS doc_filetype
     (
    ...
    $db -> exec("CREATE  TABLE IF NOT EXISTS doc_usergroup_config
     (
      id INT NOT NULL AUTO_INCREMENT,
    ...
    $db -> exec("CREATE  TABLE IF NOT EXISTS doc_filetype_forbidden
     (
      id INT NOT NULL AUTO_INCREMENT,
      usergroup VARCHAR(45) NOT NULL,
    ...
    $query = "INSERT IGNORE INTO config 
	 ...
	 VALUES (:id, :field, :value, 1, :type, 'global', 'files', UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), :description)";
    ...
    $queryThree=("INSERT IGNORE INTO doc_filetype (type) VALUES (:type)");
  ...
  public function down()
   {
    ...
    $db -> exec("DELETE FROM config WHERE field IN ('PERSONALDOCUMENT_ENABLE')");
