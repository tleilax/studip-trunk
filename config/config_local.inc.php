...
$UNI_NAME_CLEAN = 'Stud.IP Anmeldesets';    //the clean-name of your master-faculty (e.g. University of Göttingen), without html-entities (used for mail-system)
...
$ABSOLUTE_URI_STUDIP = "http://localhost/studip-as/";
...
//ImageMagick, used by latexrender modul
...
$XSLT_ENABLE = TRUE;
$FOP_ENABLE = TRUE;
$FOP_SH_CALL = "/Applications/fop/fop";                        //path to fop
...
$MESSAGING_FORWARD_AS_EMAIL = FALSE;                         //enable to forward every internal message to the user-mail (the user is able to deactivate this function in his personal settings)
...
//$_lit_search_plugins[] = array('name' => 'WisoFak', 'display_name' =>'Bibliotheken der Wirtschafts- und Sozialwiss. Fakultäten Goettingen', 'link' => 'http://goopc4.sub.uni-goettingen.de:8080/DB=2/SET=1/TTL=1/CMD?ACT=SRCHA&IKT=12&SRT=YOP&TRM={accession_number}');

/* Technische Informationsbibliothek / Universitätsbibliothek Hannover, OPAC */
//$_lit_search_plugins[] = array('name' => 'TIBUBOpac', 'display_name' =>'Technische Informationsbibliothek / Universitätsbibliothek Hannover', 'link' => 'http://opc4.tib.uni-hannover.de:8080/DB=1/SET=1/TTL=1/CMD?ACT=SRCHA&IKT=12&SRT=YOP&TRM={accession_number}', 'display_name' => "UB Katalog");
...
//$_lit_search_plugins[] = array('name' => 'FHHIOpac', 'display_name' =>'Bibliotheken der FH Hildesheim/Holzminden/Göttingen', 'link' => 'http://hidbs2.bib.uni-hildesheim.de:8080/DB=2/SET=1/TTL=1/CMD?ACT=SRCHA&IKT=12&SRT=YOP&TRM={accession_number}');

/* Thüringer Universitäts- und Landesbibliothek Jena */
//$_lit_search_plugins[] = array('name' => 'ThULB_Jena', 'display_name' =>'Thüringer Universitäts- und Landesbibliothek Jena', 'link' => 'http://jenopc4.thulb.uni-jena.de:8080/DB=1/SET=1/TTL=1/CMD?ACT=SRCHA&IKT=12&SRT=YOP&TRM={accession_number}');
...
//$_lit_search_plugins[] = array('name' => 'UB_Weimar', 'display_name' =>'Universitätsbibliothek der Bauhaus-Universität Weimar', 'link' => 'http://weias.ub.uni-weimar.de:8080/DB=1/SET=1/TTL=1/CMD?ACT=SRCHA&IKT=12&SRT=YOP&TRM={accession_number}');
...
//$_lit_search_plugins[] = array('name' => 'HSfMFL_Weimar', 'display_name' =>'Bibliothek der Hochschule für Musik Franz Liszt Weimar', 'link' => 'http://weias.ub.uni-weimar.de:8080/DB=3/SET=1/TTL=1/CMD?ACT=SRCHA&IKT=12&SRT=YOP&TRM={accession_number}');

/* Universitätsbibliothek Erfurt */
//$_lit_search_plugins[] = array('name' => 'UB_Erfurt', 'display_name' =>'Universitätsbibliothek Erfurt', 'link' => 'http://opac.uni-erfurt.de:8080/DB=1/SET=1/TTL=1/CMD?ACT=SRCHA&IKT=12&SRT=YOP&TRM={accession_number}');
...
//$_lit_search_plugins[] = array('name' => 'UB_Ilmenau', 'display_name' =>'Universitätsbibliothek Ilmenau', 'link' => 'http://ilmopc4.bibliothek.tu-ilmenau.de:8080/DB=1/SET=1/TTL=1/CMD?ACT=SRCHA&IKT=12&SRT=YOP&TRM={accession_number}');
...
//$_lit_search_plugins[] = array('name' => "Ulb", 'display_name' =>'Universitäts- und Landesbibliothek Sachsen-Anhalt Halle', 'link' => 'http://haweb1.bibliothek.uni-halle.de:8080/DB=1/SET=1/TTL=1/CMD?ACT=SRCHA&IKT=12&SRT=YOP&TRM={accession_number}');
