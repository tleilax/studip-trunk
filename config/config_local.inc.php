...
$UNI_NAME_CLEAN = "Entwicklungssystem Thinkpad";							//the clean-name of your master-faculty (e.g. University of Göttingen), without html-entities (used for mail-system)
...
$ELEARNING_INTERFACE_MODULES["ilias-hannover"] = array (
    		"name" => "ILIAS Universität Hannover",
