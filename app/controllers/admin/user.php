...
class Admin_UserController extends AuthenticatedController
{
    ...
    public function index_action($advanced = false)
    {
        ...
        if (!empty($request)) {
            ...
            $empty_search = true;
            foreach (words('username vorname nachname email inaktiv locked datafields inaktiv_tage institute studycourse degree userdomains auth_plugins perms') as $value) {
            ...
            $this->users   = !$empty_search ? User::search($request) : null;
