...
class Admin_UserController extends AuthenticatedController
{
    ...
    public function delete_action($user_id = null, $parent = '')
    {
        ...
        $delete_documents = Request::option('documents', false);
        $delete_content_from_course = Request::option('coursecontent', false);
        $delete_personal_documents = Request::option('personaldocuments', false);
        $delete_personal_content = Request::option('personalcontent', false);
        $delete_names = Request::option('personalnames', false);
        $delete_memberships = Request::option('memberships', false);
