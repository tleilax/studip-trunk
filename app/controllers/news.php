...
class NewsController extends StudipController
{
    ...
    function edit_news_action($id = '', $context_range = '', $template_id = '')
    {
        ...
        if (Request::get('news_isvisible')) {
            ...
            $this->news_isvisible = json_decode(studip_utf8decode(Request::get('news_isvisible')));
            if (Request::isXhr()) {
                $this->area_options_selected = json_decode(studip_utf8decode(Request::get('news_selected_areas')), true);
                $this->area_options_selectable = json_decode(studip_utf8decode(Request::get('news_selectable_areas')), true);
                ...
                $this->area_options_selected = json_decode(studip_utf8decode(Request::get('news_selected_areas')), true);
                $this->area_options_selectable = json_decode(studip_utf8decode(Request::get('news_selectable_areas')));
