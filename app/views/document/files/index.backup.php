 ...
 <body>
       ...
       <th style="border-top:0px;"> </th>
        ...
        ?>
            <tr>
                <td>&nbsp;</td>
                <td colspan="4">
                   <a href="<?= $controller->url_for("document/files/up/$up_dir") ?>">..</a>
                </td>
            </tr>
       <? endif; ?>
     ...
     <?php
      ...
      <tr id="<?= $id; ?>">
       ...
       <td>
        ...
        <a href="<?= $controller->url_for("document/files/openDir/$id") ?>" title="Öffnen">
       ...
       <td style="text-align:center;">
        ...
        <a href="<?= $controller->url_for("document/files/download/$file_id/$id/$env_dir") ?>" title="Herunterladen">
  ...
  <?php
   ...
   <div id="modal">
     ...
     <?= $this -> render_partial('document/files/_notification'); ?>
         ...
         <td style="border-bottom:0px;">
          ...
          <form enctype="multipart/form-data"
           ...
           <?= Studip\LinkButton::createCancel(_('Abbrechen'),
                   $controller->url_for("document/files/list/$env_dir")) ?>
       ...
       <tbody>
        ...
        <tr>
         ...
         <td style="border-bottom:0px;">
          ...
          <form action="<?= $controller->url_for("document/files/addDir/$env_dir") ?>"
                method="post">
       ...
       <tbody>
        ...
        <tr>
         ...
         <td style="border-bottom:0px;">
          ...
          <form action="<?= $controller->url_for("document/files/edit/$env_dir") ?>"
                method="post">
     ...
     <tbody>
      ...
      <tr>
       ...
       <td>
        ...
        <form action="<?= $controller->url_for("document/files/remove/$env_dir") ?>"
              method="post">
