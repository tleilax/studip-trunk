...
<h1>
    ...
    <? else : ?>
        <? if (!in_array($display_language, $translations)) : ?>
            <?= sprintf('Modulteil: <em>%s</em> in der Ausgabesprache <em>%s</em> neu anlegen.', $modulteil->getDisplayName(),
                    $GLOBALS['MVV_MODULTEIL_DESKRIPTOR']['SPRACHE']['values'][$display_language]['name']) ?>
        <? else : ?>
...
<form id="modulteil_form" class="default" action="<?= $controller->url_for('/modulteil/', $modulteil->id) ?>" method="post">
    ...
    <fieldset>
        ...
        <label for="kommentar_wl_praesenz" style="vertical-align: top;"><?= _('Kommentar') ?>
            ...
            <textarea cols="60" rows="5" name="kommentar_wl_praesenz" id="kommentar_wl_praesenz" class="add_toolbar ui-resizable wysiwyg"><?= htmlReady($deskriptor->kommentar_wl_praesenz) ?></textarea>
            <? else : ?>
            <textarea readonly cols="60" rows="5" name="kommentar_wl_praesenz" id="kommentar_wl_praesenz" class="ui-resizable"><?= htmlReady($deskriptor->kommentar_wl_praesenz) ?></textarea>
            <? endif; ?>
        </label>
    </fieldset>
    <fieldset>
        ...
        <label><?= _('Kommentar') ?>
            ...
            <textarea cols="60" rows="5" name="kommentar_wl_bereitung" id="kommentar_wl_bereitung" class="add_toolbar ui-resizable wysiwyg"><?= htmlReady($deskriptor->kommentar_wl_bereitung) ?></textarea>
            <? else : ?>
            <textarea readonly cols="60" rows="5" name="kommentar_wl_bereitung" id="kommentar_wl_bereitung" class="ui-resizable"><?= htmlReady($deskriptor->kommentar_wl_bereitung) ?></textarea>
            <? endif; ?>
        </label>
    </fieldset>
    <fieldset>
    ...
    <fieldset>
        ...
        <? endif; ?>
            <label><?= _('Kommentar') ?>
                ...
                <textarea cols="60" rows="5" name="kommentar_pflicht" id="kommentar_pflicht" class="add_toolbar ui-resizable wysiwyg"><?= htmlReady($deskriptor->kommentar_pflicht) ?></textarea>
                <? else : ?>
                <textarea readonly cols="60" rows="5" name="kommentar_pflicht" id="kommentar_pflicht" class="ui-resizable"><?= htmlReady($deskriptor->kommentar_pflicht) ?></textarea>
                <? endif; ?>
            </label>
    </fieldset>
