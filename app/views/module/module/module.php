    ...
    <tbody class="<?= ($modul->count_modulteile ? '' : 'empty ') ?><?= ($modul_id == $modul->getId() ? 'not-collapsed' : 'collapsed') ?>">
        ...
        <tr class="header-row" id="modul_<?= $modul->getId() ?>">
            ...
            <td class="dont-hide toggle-indicator">
                <a class="mvv-load-in-new-row" href="<?= $controller->url_for($details_url, $modul->getId()) ?>" style="background-image: none; padding: 0;">
            ...
            <td class="dont-hide actions" style="white-space: nowrap;">
                ...
                <? if ($perm->havePermWrite()) : ?>
                    <? $actionMenu->addLink(
                        ...
                        _('Modul bearbeiten'),
                        Icon::create('edit', 'clickable', ['title' => _('Modul bearbeiten')])
                    ) ?>
                <? endif; ?>
                ...
                <? if ($perm->havePermCreate()) : ?>
                    <? $actionMenu->addButton(
                        'delete',
                        _('Modul löschen'),
                        Icon::create('trash', 'clickable', ['title' => _('Modul löschen')]),
                        [
