...
<form class="default" action="<?= $controller->url_for('/studiengang', $studiengang->id) ?>" method="post">
    ...
    <fieldset>
        ...
        <textarea cols="60" rows="5" name="kommentar_status" id="kommentar_status" class="add_toolbar ui-resizable wysiwyg"><?= htmlReady($studiengang->kommentar_status) ?></textarea>
            <? else: ?>
