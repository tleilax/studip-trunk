            ...
            <tr>
                ...
                <td>
                    <ul class="clean" style="max-height: 310px; overflow: auto;">
                        ...
                        <li>
                            <label>
                                <?= Icon::create('date', 'info')->asImg(16, ['class' => "text-bottom"]) ?>
                            ...
                            (
                                <? foreach ($localtopics as $key => $localtopic) : ?>
                                    <a href="<?= URLHelper:: getLink("dispatch.php/course/topics/index", array('open' => $localtopic->getId())) ?>">
                                        <?= Icon::create('topic', 'clickable')->asImg(16, ['class' => "text-bottom"]) ?>
            ...
            <? if ($documents_activated) : ?>
                <tr>
                    ...
                    <td>
                        <? $folder = $topic->folder ?>
                        <? if ($folder) : ?>
                            <?= Icon::create('accept', 'accept')->asImg(16, ['class' => "text-bottom"]) ?>
