...
if (count($tour->steps)) {
    ...
    $widget->addLink(_('Schritt hinzufügen'), URLHelper::getLink('dispatch.php/tour/edit_step/' . $tour->tour_id . '/' . (count($tour->steps) + 1) . '/new'), Icon::create('add', 'clickable'), ['data-dialog' => 'size=auto;reload-on-close']);
