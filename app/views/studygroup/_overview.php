    ...
    <tr class="sortable" title="<?=_("Klicken, um die Sortierung zu ändern")?>">
        ...
        <? foreach ($groups as $group) : ?>
            <tr>
                ...
                <td align="center">
                    <? if (StudygroupModel::isMember($this->userid,$group['Seminar_id'] )) :?>
                        <?=Icon::create('person', 'inactive', ['title' => _('Sie sind Mitglied in dieser Gruppe')])->asImg(16)?>
                    <? endif;?>
                </td>
                <td align="center">
                    <? if ($group['admission_prelim'] == 1) :?>
                        <?=Icon::create('lock-locked', 'inactive', ['title' => _('Mitgliedschaft muss beantragt werden')])->asImg(16)?>
                    <? endif;?>
                </td>
            </tr>
    <? endforeach ; ?>
