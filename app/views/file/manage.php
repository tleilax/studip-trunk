...
<div id="file_management_forms" style="width:79%; display:table;" class="ui-accordion">
    <h3 class="ui-accordion-header"><?= _('Datei bearbeiten') ?></h3>
    ...
    <h3 class="ui-accordion-header"><?= _('Datei kopieren') ?></h3>
    <div class="ui-accordion-content">
    ...
    <h3 class="ui-accordion-header"><?= _('Datei verschieben') ?></h3>
    <div class="ui-accordion-content">
        <form class="default" action="<?= $controller->url_for('/move/'. $file_ref->id); ?>">
            <fieldset>
    ...
    <h3 class="ui-accordion-header"><?= _('Datei löschen') ?></h3>
    <div class="ui-accordion-content">
