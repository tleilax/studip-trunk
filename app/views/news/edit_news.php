...
<? if(!empty($flash['question_text'])) : ?>
    <? $form_content = array('news_isvisible' => htmlReady(json_encode(studip_utf8encode($news_isvisible))),
              'news_selectable_areas' => htmlReady(json_encode(studip_utf8encode($area_options_selectable))),
              'news_selected_areas' => htmlReady(json_encode(studip_utf8encode($area_options_selected))),
              'news_basic_js' => '',
              'news_comments_js' => '',
              'news_areas_js' => '',
...
<input type="hidden" name="news_isvisible" value="<?=htmlReady(json_encode(studip_utf8encode($news_isvisible)))?>">
<input type="hidden" name="news_selectable_areas" value="<?=htmlReady(json_encode(studip_utf8encode($area_options_selectable)))?>">
<input type="hidden" name="news_selected_areas" value="<?=htmlReady(json_encode(studip_utf8encode($area_options_selected)))?>">
