        ...
        <tr>
            ...
            <td width="80%" class="sem_class_name">
                <div>
                    ...
                    <a href="#" class="sem_class_edit" onClick="jQuery(this).closest('td').children().toggle().find('input:visible').focus(); return false;"><?= Icon::create('edit', 'clickable')->asImg(16, ['class' => "text-bottom"]) ?></a>
                </div>
            ...
            <td class="sem_class_name">
                <div>
                    ...
                    <a href="#" class="sem_class_edit" onClick="jQuery(this).closest('td').children().toggle().find('input:visible').focus(); return false;">
                        <?= Icon::create('edit', 'clickable')->asImg(16, ['class' => 'text-bottom']) ?></a>
                </div>
            ...
            <td>
                ...
                <div class="add">
                    <div style="display: none; margin-left: 37px;">
                        ...
                        <a href="" onClick="STUDIP.admin_sem_class.add_sem_type(); return false;"><?= Icon::create('arr_2up', 'sort')->asImg(16, ['class' => "text-bottom", "title" => _("hinzufügen")]) ?></a>
                    </div>
                    <div style="margin-left: 21px;">
                        <a href="#" onClick="jQuery(this).closest('.add').children().toggle(); jQuery('#new_sem_type').focus(); return false;">
                            <?= Icon::create('add', 'clickable')->asImg(16, ['class' => "text-bottom", "title" => _("Veranstaltungstyp hinzufügen")]) ?>
                        </a>
                    </div>
                </div>
            </td>
