...
<form action="<?= $controller->url_for('/edit_profession', $edit->id) ?>" method="post">
    ...
    <table class="default">
        ...
        <tr class="table_footer">
            ...
            <td>
                 ...
                 <?= LinkButton::createCancel(_('Abbrechen'), $controller->url_for('/profession'), array('title' => _('Zurück zur Übersicht')))?>
            </td>
        </tr>
    </table>
</form>