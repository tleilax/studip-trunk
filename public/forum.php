...
// Schreibmodus setzen
////////////////////////////////////////////////////////////////////////////////
if ($cmd == 'toggle_lock' && $rechte){
	$db = new DB_Seminar();
	$db->query("UPDATE px_topics SET read_only=IF(read_only=1,0,1) WHERE topic_id='$topic_id' AND root_id='$topic_id' AND seminar_id='$SessionSeminar'");
}
//////////////////////////////////////////////////////////////////////////////////
