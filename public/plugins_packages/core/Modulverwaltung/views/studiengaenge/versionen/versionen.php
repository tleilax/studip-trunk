        ...
        <tr class="header-row">
            ...
            <td class="dont-hide" style="text-align: center;">
                <? if ($version->count_dokumente) : ?>
                    <?= Icon::create('staple', 'info', ['title' => sprintf(ngettext('%s Dokument zugeordnet', '%s Dokumente zugeordnet', $version->count_dokumente), $version->count_dokumente)])->asImg(); ?>
                <? endif; ?>
            </td>
                ...
                <form method="post">
                    ...
                    <? if ($version->stat == 'planung' && MvvPerm::haveFieldPermStat($version)) : ?>
                        <? $actionMenu->addLink(
                                ...
                                Icon::create('accept', 'clickable', ['title' => _('Version genehmigen')]),
                    ...
                    <? if ($perm->haveFieldPerm('abschnitte', MvvPerm::PERM_CREATE)) : ?>
                        <? $actionMenu->addLink(
                                ...
                                Icon::create('file+add', 'clickable', ['title' => _('Studiengangteil-Abschnitt anlegen')]),
                                ['data-dialog' => true])
                        ?>
                    <? endif; ?>
                    <? if ($perm->havePermWrite()) : ?>
                        <? $actionMenu->addLink(
                                ...
                                Icon::create('edit', 'clickable', ['title' => _('Version bearbeiten')]))
                        ?>
                    <? endif; ?>
