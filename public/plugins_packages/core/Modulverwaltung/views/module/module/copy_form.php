...
<form class="default" action="<?= $submit_url ?>" method="post">
    ...
    <section>
        <dl>
            ...
            <dd>
                <?
                echo htmlReady($end_sem->name ?: _('unbegrenzt'));
                ?>
            </dd>
        </dl>
    </section>
        ...
        <dl>
            ...
            <dd>
                ...
                <? foreach (Semester::getAll() as $end_sem_new) : ?>
                    ...
                    <option value="<?= htmlReady($end_sem_new->id) ?>"><?= htmlReady($end_sem_new->name) ?></option>
                    <? endif; ?>
                <? endforeach; ?>
                </select>
            </dd>
    ...
    <section>
        <p>
            ...
            <?= Icon::create('info-circle', 'clickable', array('title' => _('Zuordnungen anzeigen')))->asImg(); ?>
            </a>
        </p>
    </section>
    <? endif; ?>
    <footer data-dialog-button>
        ...
        <?= Button::createAccept(_('Kopieren'), 'copy', array('title' => _('Modul kopieren'))) ?>
        <? endif; ?>
