...
<table class="default collapsable">
    <caption><?= _('Liste der verantwortlichen Einrichtungen') ?></caption>
    <colgroup>
        <col>
    ...
    <tr class="header-row" id="institut_<?= $institut->id ?>">
        <td class="toggle-indicator">
            ...
            <a class="mvv-load-in-new-row" href="<?= $controller->url_for('/details', ['institut_id' => $institut->id]) ?>"><?= htmlReady($institut->getDisplayName()) ?> </a>
            <? else : ?>
