  ...
  if (!$admin_admission_data["admission_type"]) {
    ...
    //Alles was mit der Anmeldung zu tun hat ab hier
      ...
      if (Request::submitted('toggle_admission_quota')){
        ...
        if (!Request::option('commit_no_admission_data')) { //wenn Ansicht gesperrt ist (Dozentenview) hier keine Ubernahmen

            if (!check_and_set_date(Request::quoted('adm_tag'), Request::quoted('adm_monat'), Request::quoted('adm_jahr'), Request::quoted('adm_stunde'),
                    Request::quoted('adm_minute'), $admin_admission_data, "admission_endtime")) {
