                ...
                <table cellspacing=0 cellpadding=2 border=0 width="99%" align="center">
                    ...
                    <tr <? $cssSw->switchClass() ?>>
                        ...
                        <td class="<? echo $cssSw->getClass() ?>" width="90%" colspan=3>
                            ...
                            <img  src="<?= $GLOBALS['ASSETS_URL'] ?>images/icons/16/grey/info-circle.png"
                                <? echo tooltip(sprintf(_("Bitte markieren Sie hier alle Einrichtungen, an denen die Veranstaltung ebenfalls angeboten wird. Bitte beachten Sie: Sie können später nur %s aus den Einrichtungen auswählen, die entweder als Heimat- oder als beteiligte Einrichtung markiert worden sind. Sie können mehrere Einträge markieren, indem Sie die STRG bzw. APPLE Taste gedrückt halten und dann auf die Einträge klicken."), get_title_for_status('dozent', 2, $_SESSION['sem_create_data']["sem_status"])), TRUE, TRUE) ?>
                            >
                        </td>
                    </tr>
                    <tr <? $cssSw->switchClass() ?>>
                ...
                <table width ="99%" cellspacing=0 cellpadding=2 border=0 align="center">
                    ...
                    <tr <? $cssSw->switchClass() ?>>
                     ...
                     //     printf ("&nbsp; <a href=\"%s\"><img src=\"".$GLOBALS['ASSETS_URL']."images/icons/16/blue/trash.png\" border=\"0\"></a> &nbsp; <font size=\"-1\"><b>%s (%s)&nbsp; &nbsp; <br>", URLHelper::getLink("?delete_doz=".get_username($key)), get_fullname($key,"full_rev",true), get_username($key));
                            ...
                            &nbsp; <img  src="<?= $GLOBALS['ASSETS_URL'] ?>images/icons/16/grey/info-circle.png"
                                <?
                                echo tooltip(sprintf(_("Die Namen der Benutzer, die die Veranstaltung leiten. Nutzen Sie die Suchfunktion, um weitere Eintragungen vorzunehmen, oder das Mülltonnensymbol, um Einträge zu löschen."), get_title_for_status('dozent', 2, $_SESSION['sem_create_data']["sem_status"])), TRUE, TRUE);
                                ?>
                            >
                            <font color="red" size=+2>*</font>
                        </td>
