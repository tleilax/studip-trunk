		...
		if (isset($_my_sem_open[$group_id])){
			...
			foreach ($group_members as $member){
				...
				if (($values["status"]=="dozent") || ($values["status"]=="tutor"))
					echo "<td class=\"".$cssSw->getClass()."\"  align=center><a href=\"admin_seminare1.php?select_sem_id=$semid\"><img width=\"19\" height=\"17\" src=\"".$GLOBALS['ASSETS_URL']."images/admin.gif\" ".tooltip(_("Veranstaltung administrieren"))." border=\"0\" /></a>&nbsp;</td>";
