...
// a primitive popup-window-function for the exclamation mark
?>
<TABLE width="100%" border="0" cellpadding="2" cellspacing="0">
	...
	<? /* message handling
	    * ~~~~~~~~~~~~~~~~
			*
	    * Messages added by one of the following commands are shown here:
			*   createError();		- error message
			*   createInfo();			- info message - black text, yellow exclamation-sign
			*   createMessage();	- success message - green text, green ok-sign
			*/
	?>
	...
	<? } ?>
	<? /*
			* The following code-snippet is only necessary if we choose the model of editing all the stuff
			* and save it when button is pressed.
			* Otherwise (as it is now) the changes are made directly.
			*/
	?>
	<!--<tr>
  ...
  <TR>
	...
	<TR>
		<TD colspan="9" class="printhead">
			<FONT size="-1">
				&nbsp;<B><?=_("regelm&auml;&szlig;ige Zeiten")?></B>
			</FONT>
		</TD>
	</TR>
	<TR>
