            ...
            if (do_template("show_questionblock_headline")) {
                ...
                if ($ausgabeformat==1 && !$freetype) {
                    if ($group_type === 'normal') {
                        ...
                        echo Icon::create('vote-stopped', 'clickable', ['title' => sprintf(_('Zum Darstellungstyp %s wechseln'), _('Tabelle'))])->asImg(16);
                        echo '</a>';
                    } else {
                        ...
                        echo Icon::create('vote', 'clickable', ['title' => sprintf(_('Zum Darstellungstyp %s wechseln'), _('Normal'))])->asImg(16);
                    }
                } else {
                    echo '&nbsp;';
                }
