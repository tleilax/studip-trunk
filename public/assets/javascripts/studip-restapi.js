...
(function ($, STUDIP) {
    ...
    RESTAPI.prototype.request = function (url, options) {
        ...
        if (options.async && this.request_count > 0) {
            ...
            if (this.request_count === 0 && options.overlay) {
                STUDIP.Overlay.show(true, null, true);
            }
    ...
    // Attach RESTAPI client instance to STUDIP namespace
    STUDIP.api = new RESTAPI();

    // Expose RESTAPI object to STUDIP namespace
    STUDIP.RESTAPI = RESTAPI;
