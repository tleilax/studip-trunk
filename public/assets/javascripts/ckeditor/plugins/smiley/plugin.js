 ...
 * @member CKEDITOR.config
 */
CKEDITOR.config.smiley_columns = 4;
CKEDITOR.config.smiley_path = STUDIP.ABSOLUTE_URI_STUDIP + 'pictures/smile/',
CKEDITOR.config.smiley_images = [
	'smile.gif','zwinker.gif','hi.gif','lol.gif','surprised.gif','biggrin.gif','frown.gif','rolling.gif','shy.gif','sun.gif','thumb.gif','wavey.gif','wink.gif','wobble.gif','tongue2.gif','znaika.gif'
];
...
CKEDITOR.config.smiley_descriptions = [
    ':smile:',':zwinker:',':hi:',':lol:',':surprised:',':biggrin:',':frown:',':rolling:',':shy:',':sun:',':thumb:',':wavey:',':wink:',':wobble:',':tongue2:',':znaika:'
];
