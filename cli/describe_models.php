...
foreach ($dir as $fileinfo) {
    ...
    if (!in_array($class, words('ModuleManagementModelTreeItem ModuleManagementModel SimpleCollection SimpleORMap SimpleORMapCollection StudipArrayObject')) && class_exists($class)) {
        echo $class . "\n";
        $model = new $class;
