...
/*
kalenderSettings.inc 0.7.5-20020224
...
// Benutzereinstellungen bernehmen
		...
		<td class="blank">
			...
			<table width ="100%" cellspacing="1" cellpadding="1" border=0>
				...
				<tr>
					...
					<?
						// sorgt fr Rcksprung in letzte Ansicht in kalender.php
						if(substr(strrchr($PHP_SELF, "/"), 1) == "kalender.php" && !empty($calendar_sess_control_data["view_prv"]))
