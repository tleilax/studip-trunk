...
/*
kalenderClass.php - 0.7.5.20020312
...
class Termin{
	...
	var $mkd = -1;    // Erstellungsdatum (int) wird überschrieben, falls Termin aus DB geholt wird
	...
	function Termin($start = "", $end = "", $txt = "", $exp = "", $cat = "", $prio = 1, $loc = "", $id = "", $type = -2){
		...
		// nur persönliche Termin haben per default eine Farbe
		// für Veranstaltungstermine muss eine Farbe explizit mit setColor() gesetzt werden
		if($this->type == -1 || $this->type == -2)
	...
	function save(){
		global $TERMIN_TYP;
		// Natürlich nur Speichern, wenn sich was geändert hat
		// und es sich um einen persönlichen Termin handelt
	...
	function clone(){
		...
		// Das Erstellungsdatum wird hier erstmal ganz bewusst nicht übernommen
		//if($this->mkd != -1)
			//$cloned->mkd = $this->mkd;
