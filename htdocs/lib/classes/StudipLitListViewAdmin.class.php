...
class StudipLitListViewAdmin extends TreeView{
	...
	*/
	...
	function execCommandInsertItem(){
		...
		if ($this->mode != "NewItem"){
			if (isset($_REQUEST['edit_content'])){
				$affected_rows = $this->tree->updateContent($_REQUEST['edit_content'], $user_id);
				if ($affected_rows){
					$this->msg[$item_id] = "msg§" . _("Die allgemeine Literaturliste wurde ge&auml;ndert.");
				} else {
					$this->msg[$item_id] = "info§" . _("Keine Ver&auml;nderungen vorgenommen.");
				}
			} else if (isset($_REQUEST['edit_note'])){
				...
				$affected_rows = $this->tree->updateList(array('list_id' => $item_id,'format' => $_REQUEST['edit_format'],'name' => $_REQUEST['edit_name'],'user_id' => $user_id));
				if ($affected_rows){
	...
	function getItemContent($item_id){
		...
		if (!$edit_content){
			if ($item_id == "root"){
				...
				$content .= "\n<tr><td class=\"steel1\" align=\"left\">" . formatReady($this->tree->tree_data['root']['content']) ." &nbsp;</td></tr>";
				...
				$content .= "\n<tr><td class=\"steelkante\" align=\"left\" style=\"font-size:10pt\">" . _("Vorschau:") ." </td></tr>";
				$content .= "\n<tr><td class=\"steel1\" align=\"left\" style=\"font-size:10pt\">" . formatReady($this->tree->getFormattedEntry($item_id)) ." </td></tr>";
			} else {
				$content .= "\n<tr><td class=\"steelkante\" align=\"left\" style=\"font-size:10pt\">" . _("Formatierung:") ." </td></tr>";
				$content .= "\n<tr><td class=\"steel1\" align=\"left\" style=\"font-size:10pt\">" . htmlReady($this->tree->tree_data[$item_id]['format'],false,true) ." &nbsp;</td></tr>";
			}
		} else {
	...
	function getEditItemContent(){
		$content .= "\n<table width=\"100%\" border =\"0\"  style=\"font-size: 10pt;\" cellpadding=\"2\" cellspacing=\"2\" align=\"center\">";
		...
		if ($this->edit_item_id == "root"){
			$edit_name = "content";
			$rows = 20;
			$content .= "\n<tr><td class=\"steelkante\" ><b>". _("Allgemeine Literaturliste bearbeiten:") . "</b></td></tr>";
			$content .= "<tr><td class=\"steel1\" align=\"center\"><textarea name=\"edit_{$edit_name}\" style=\"width:100%\" rows=\"$rows\">" . $this->tree->tree_data[$this->edit_item_id][$edit_name]
				. "</textarea></td></tr>";
		} else if ($this->tree->isElement($this->edit_item_id)){
			$content .= "\n<tr><td class=\"steelkante\" ><b>". _("Anmerkung zu einem Eintrag bearbeiten:") . "</b></td></tr>";
			$edit_name = "note";
			$rows = 5;
			$content .= "<tr><td class=\"steel1\" align=\"center\"><textarea name=\"edit_{$edit_name}\" style=\"width:100%\" rows=\"$rows\">" . $this->tree->tree_data[$this->edit_item_id][$edit_name]
				. "</textarea></td></tr>";
		} else {
			$content .= "\n<tr><td class=\"steelkante\" ><b>". _("Name der Liste bearbeiten:") . "</b></td></tr>";
			$content .= "<tr><td class=\"steel1\" align=\"center\"><input type=\"text\" name=\"edit_name\" style=\"width:100%\" value=\"" . $this->tree->tree_data[$this->edit_item_id]['name']
				. "\"></td></tr>";
			$edit_name = "format";
			$rows = 2;
			$content .= "\n<tr><td class=\"steelkante\" ><b>". _("Formatierung der Liste bearbeiten:") . "</b></td></tr>";
			$content .= "<tr><td class=\"steel1\" align=\"center\"><textarea name=\"edit_{$edit_name}\" style=\"width:100%\" rows=\"$rows\">" . $this->tree->tree_data[$this->edit_item_id][$edit_name]
				. "</textarea></td></tr>";
		}
		$content .= "<tr><td class=\"steel1\" align=\"right\"><input type=\"image\" "
