...
$this->msg[8] = array (
		"mode" => "error",
		"msg"=> _("Bitte w&auml;hlen Sie zun&auml;chst einen Vertrag aus, um die Anfragen einzusehen oder zu bearbeiten!"));>>>>>>> 1.3
$this->msg[9] = array (
		"mode" => "info",
		"msg"=> _("Es existieren keine Tutoren oder Autoren, die mit der Anfrage verkn&uuml;pft werden k&ouml;nnten."));
