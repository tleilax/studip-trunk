...
function show_sigform() {
	...
	if ($sms_data["sig"] == "1") {
		...
		$tmp .=  _("Dieser Nachricht wird keine Signatur angehängt");
			$tmp .= "<br><input type=\"image\" name=\"add_sig_button\" src=\"./pictures/add_sig.gif\" border=\"0\" ".tooltip(_("fügt der aktuellen Nachricht eine Signatur an.")).">&nbsp;"._("Signatur anhängen.");
		$tmp .= "</font>";
	}
...
<tr>	
	...
	// we simly answer, not more or less
	if ($answer_to && !$quote) {
