...
Copyright (C) 2000 Ralf Stockmann <rstockm@gwdg.de>, Stefan Suchi <suchi@gmx.de>, AndrÇ Noack <andre.noack@gmx.net>
...
// wichtiger Teil aus seminar_open.php
	...
	IF (isset($auswahl) && $auswahl!="") {
		...
		$db=new DB_Seminar;
		$db->query ("SELECT Name , Seminar_id ,Institut_id, Ort , Untertitel , start_time FROM seminare WHERE Seminar_id='$auswahl'");
		if ($db->next_record())
			{
