...
print "<tr><td class=steel1 align=\"right\" width=\"15%\">Benutzername: </td>";
...
print "<td class=steel1 align=\"right\" width=\"15%\">Vorname: </td>";
...
print "<td class=steel1 align=\"right\" width=\"15%\">E-Mail: </td>";
...
print "<td class=steel1 align=\"right\" width=\"15%\">Nachname: </td>";
...
print "<td class=steel1 align=\"right\" width=\"15%\">Status: </td>";
print "<td class=steel1 align=\"left\" width=\"35%\">";
	perm_select("pers_browse_perms",$pers_browse_old[perms]);
print "</td>\n";
print "<td class=steel1 align=\"right\" width=\"15%\">inaktiv: </td>";
...
print "<tr><td class=steel1>&nbsp</td><td class=steel1 align=\"left\"><input type=submit name=\"pers_browse_search\" value=\" Suche starten \"></td>\n";
print "<td class=steel1>&nbsp</td><td class=steel1 colspan=2 align=\"left\"><input type=submit name=\"pers_browse_clear\" value=\" Formular zur&uuml;cksetzen \"></td></tr>\n";
