...
<?
	...
	if ($folder_system_data["cmd"]=="all") {
		...
		<?
		print ("<div align=\"right\"><a style=\"vertival-align: middle;\" href=\"$PHP_SELF?check_all=TRUE\">".makeButton("alleauswaehlen")."&nbsp;<input style=\"vertical-align: middle;\" type=\"IMAGE\" name=\"download_selected\" border=\"0\" ".makeButton("herunterladen", "src")." />&nbsp;</div>");		
		}
