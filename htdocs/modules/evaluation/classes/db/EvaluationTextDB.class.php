 ...
 * @access public
 */
define ("INSTANCEOF_EVALTEXTDB", "EvalTEXTDB");
# =========================================================================== #
 ...
 *
 */
class EvaluationTextDB extends EvaluationObjectDB {
...
# Define constructor and destructor ========================================= #
   ...
   * @access   public
   */
  function EvaluationTextDB () {
    /* Set default values -------------------------------------------------- */
    parent::EvaluationObjectDB ();
    $this->instanceof = INSTANCEOF_EVALTEXTDB;
    /* --------------------------------------------------------------------- */
  }
