...
IF (!$forumsend=="anpassen") {
	...
	echo "<tr><td class=\"topic\" width=\"95%\"><b>&nbsp;<img src='pictures/icon-posting.gif' align=absmiddle>&nbsp; ". htmlReady($SessSemName["art"]) .": ". htmlReady($SessSemName[0])." - Forum</b></td><td class=\"topic\" width=\"5%\" align=\"right\"><a href='forum.php?forumsend=anpassen'><img src='pictures/pfeillink.gif' border=0 alt='Look & Feel anpassen'>&nbsp;</a></td></tr>\n";
