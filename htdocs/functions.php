		...
		switch ($SemSecLevelWrite) {
			...
			case 1 :
				if ($perm->have_perm("autor"))
					$error_msg=$error_msg."info∫Sie mÅssen sich erneut fÅr diese Veranstaltung anmelden, um schreiben zu k˜nnen!<br>Hie kommen sie zur <a href=\"sem_verify.php\">Freischaltung</a> der Veranstaltung.∫";
