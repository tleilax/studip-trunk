...
function printQuestionField ( $question = "" ) {
    ...
    if( $pageMode != MODE_RESTRICTED ) {
    $html .= "<textarea class=\"add_toolbar wysiwyg\" cols=50 rows=2 style=\"width:100%;\" name=\"question\" ".$js." tabindex=\"2\" placeholder=\"".htmlReady($placeholder)."\">".htmlReady($question)."</textarea>";
    } else {
