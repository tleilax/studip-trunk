    ...
    */
    ...
    function showSemRangeTree(){
        ...
        if ($this->start_item_id != "root"){
            ...
            Icon::create('arr_2left', 'clickable')->asImg(16, ['class' => 'text-top', 'title' =>_('eine Ebene zurück')]). "</a>";
        } else {
            echo "&nbsp;";
        }
        echo "</td></tr>";
        ...
        if ($item_id != "root"){
            if ($this->tree->hasKids($item_id) && ($num_entries = $this->tree->getNumEntries($this->start_item_id,true))){
                if ($this->show_entries != "sublevels"){
                    ...
                    echo Icon::create('arr_1right', 'clickable')->asImg(16);
                    echo '&nbsp;';
                } else {
                    echo Icon::create('arr_1down', 'clickable')->asImg(16);
                    echo '&nbsp;';
                }
            ...
            if ($num_entries = $this->tree->getNumEntries($item_id)){
                if ($this->show_entries != "level"){
                    ...
                    echo Icon::create('arr_1right', 'attention')->asImg(16);
                    echo '&nbsp;';
                } else {
                    echo Icon::create('arr_1down', 'attention')->asImg(16);
                    echo '&nbsp;';
                }
    ...
    function getSemPath(){
        ...
        $ret .= Icon::create('info-circle', 'inactive')->asImg(16);
        $ret .= "</a>";
        return $ret;
    }
