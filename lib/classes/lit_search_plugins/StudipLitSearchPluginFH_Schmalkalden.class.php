...
* @package
**/
class StudipLitSearchPluginFH_Schmalkalden extends StudipLitSearchPluginGvk{

	function StudipLitSearchPluginFH_Schmalkalden(){
		parent::StudipLitSearchPluginGvk();
		$this->description = 'Bibliothek der Fachhochschule Schmalkalden';
		$this->z_host = "z3950.gbv.de:20010/fhsk_opc";
