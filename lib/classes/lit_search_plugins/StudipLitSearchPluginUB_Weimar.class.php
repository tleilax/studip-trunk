...
* @package
**/
class StudipLitSearchPluginUB_Weimar extends StudipLitSearchPluginGvk{

	function StudipLitSearchPluginUB_Weimar(){
		parent::StudipLitSearchPluginGvk();
		$this->description = 'Universit&auml;tsbibliothek der Bauhaus-Universit&auml;t Weimar';
		$this->z_host = "z3950.gbv.de:20010/ubwei_opc";
