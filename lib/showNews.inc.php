...
function show_news($range_id, $show_admin = FALSE, $limit = "", $open, $width = "100%", $last_visited = 0, $cmd_data)
{
	...
	if (!count($news)) {
		if ($show_admin) {
			...
			echo"</td></tr>";
			echo "\n<tr><td class=\"steel1\" colspan=\"3\"><blockquote><font size=\"-1\">" . _("Es sind keine aktuellen News vorhanden. Um neue News zu erstellen, klicken Sie auf die Doppelpfeile.") . "<br>  </font></blockquote>";
			echo "\n</td></tr></table>";
			return TRUE;
		} else {
			return FALSE;
