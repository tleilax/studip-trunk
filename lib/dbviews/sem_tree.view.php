...
$GLOBALS['_views']["SEM_INST_GET_SEM"] = array("query" => "SELECT c.Seminar_id, c.visible, " . $GLOBALS['_views']['sem_number_sql'] . " AS sem_number , " . $GLOBALS['_views']['sem_number_end_sql'] . " AS sem_number_end FROM seminar_inst a LEFT JOIN seminare c USING (seminar_id) WHERE a.Institut_id IN (&) AND c.Seminar_id IS NOT NULL
												§ § ");
