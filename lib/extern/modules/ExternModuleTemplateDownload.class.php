				...
				switch ($file_suffix[1]) {
					case 'txt' :
						if (!$content['FILES']['FILE'][$i]['FILE_ICON-HREF'] = $this->config->getValue('Main', 'icontxt'))
							$content['FILES']['FILE'][$i]['FILE_ICON-HREF'] = $GLOBALS['ABSOLUTE_URI_STUDIP'].$GLOBALS['ASSETS_URL'].'images/txt-icon.gif';
						break;
					case 'xls' :
						if (!$content['FILES']['FILE'][$i]['FILE_ICON-HREF'] = $this->config->getValue('Main', 'iconxls'))
							$content['FILES']['FILE'][$i]['FILE_ICON-HREF'] = $GLOBALS['ABSOLUTE_URI_STUDIP'].$GLOBALS['ASSETS_URL'].'images/xls-icon.gif';
						break;
					case 'ppt' :
						if (!$content['FILES']['FILE'][$i]['FILE_ICON-HREF'] = $this->config->getValue('Main', 'iconppt'))
							$content['FILES']['FILE'][$i]['FILE_ICON-HREF'] = $GLOBALS['ABSOLUTE_URI_STUDIP'].$GLOBALS['ASSETS_URL'].'images/ppt-icon.gif';
						break;
					case 'rtf' :
						if (!$content['FILES']['FILE'][$i]['FILE_ICON-HREF'] = $this->config->getValue('Main', 'iconrtf'))
							$content['FILES']['FILE'][$i]['FILE_ICON-HREF'] = $GLOBALS['ABSOLUTE_URI_STUDIP'].$GLOBALS['ASSETS_URL'].'images/rtf-icon.gif';
						break;
					case 'zip' :
					case 'tgz' :
					case 'gz' :
						if (!$content['FILES']['FILE'][$i]['FILE_ICON-HREF'] = $this->config->getValue('Main', 'iconzip'))
							$content['FILES']['FILE'][$i]['FILE_ICON-HREF'] = $GLOBALS['ABSOLUTE_URI_STUDIP'].$GLOBALS['ASSETS_URL'].'images/zip-icon.gif';
						break;
					case 'jpg' :
					case 'png' :
					case 'gif' :
					...
					case 'tif' :
						if (!$content['FILES']['FILE'][$i]['FILE_ICON-HREF'] = $this->config->getValue('Main', 'iconpic'))
							$content['FILES']['FILE'][$i]['FILE_ICON-HREF'] = $GLOBALS['ABSOLUTE_URI_STUDIP'].$GLOBALS['ASSETS_URL'].'images/pic-icon.gif';
						break;
					case 'pdf' :
						if (!$content['FILES']['FILE'][$i]['FILE_ICON-HREF'] = $this->config->getValue('Main', 'iconpdf'))
							$content['FILES']['FILE'][$i]['FILE_ICON-HREF'] = $GLOBALS['ABSOLUTE_URI_STUDIP'].$GLOBALS['ASSETS_URL'].'images/pdf-icon.gif';
						break;
					default :
