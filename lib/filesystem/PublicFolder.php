...
class PublicFolder extends StandardFolder
{
    ...
    public function getEditTemplate()
    {
        ...
        $template->set_attributes($this->folderdata);
        return $template;
    }

    public function setDataFromEditTemplate($request)
    {
        $this->viewable = $request['public_folder_viewable'];
        return parent::setDataFromEditTemplate($request); // TODO: Change the autogenerated stub
    }
}