            ...
            <TR>
                <TD width="70%" class="table_row_even">
                    <FONT size="-1">
                        ...
                        <textarea class="add_toolbar wysiwyg" name="theme_description<?=$openAll ? '§'.$tpl['sd_id']: ''?>" rows="5" cols="50" style="width: 98%"><?= htmlReady($tpl['theme_description']) ?></textarea><br>
                    </FONT>
                </TD>
...
<tr style="height: 1.8em">
    <TD width="1%" align="right" valign="bottom" class="content_title_red" nowrap="nowrap">
        <?= Icon::create('arr_1right', 'clickable')->asImg(['class' => 'middle']) ?>
    </TD>
    <TD width="1%" align="right" valign="bottom" class="content_title_red" nowrap="nowrap">
        <A name="<?=$tpl['sd_id']?>" />
        <?= Icon::create('date', 'clickable')->asImg(['class' => 'middle']) ?>
