...
//oberen Reiter
$structure = array();
$structure["resources"]=array ("topKat"=>"", "name"=>_("Übersicht"), "link"=>"resources.php?view=search&reset=TRUE", "active"=>FALSE);
...
//$structure["edit_personal_settings"]=array ("topKat"=>"settings", "name"=>_("persönliche Einstellungen"), "link"=>"resources.php?view=edit_personal_settings", "active"=>FALSE);
//
